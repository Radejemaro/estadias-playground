...
@section('Contenido')
    ...
    <script src="{{ asset('JS/ddl_buttons_Print.js') }}"></script>
        ...
        <table id="printers-table">
            ...
            <tbody>
                @foreach ($printers as $printers)
                    <tr data-id="{{ $printers->id }}">
                        <td>{{ $printers->NOMBRE_PC }}</td>
                        <td>{{ $printers->No_SERIE }}</td>
                        <td>{{ $printers->MODELO_PC }}</td>
                        <td>{{ $printers->TIPO }}</td>
                        <td>{{ $printers->PUESTO }}</td>
                    </tr>
                @endforeach
             </tbody>
        </table><br>
